...
public class GameSimulator extends Game {
    ...
    public int getAdvice() {
        ...
        // check rank here
        /*
         * if (this.hand.checkFlush('S', 5, 'N').size() != 0 ||
         * this.hand.checkFourOfAKind().size() != 0
         ...
         * 
         * // TODO:
         * else if (this.hand.checkStraight().size() != 0 || this.hand.checkFlush('N',
         * 5, 'N').size() != 0
         ...
         * 
         * else if (this.hand.checkPairSuits(13, 11, 'U').size() != 0 ||
         * this.hand.checkPairSuits(13, 12, 'U').size() != 0)
